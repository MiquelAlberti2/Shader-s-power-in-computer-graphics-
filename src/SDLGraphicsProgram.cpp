...
void SDLGraphicsProgram::Loop(){
    ...
    //myTerrain->LoadTexture("colormap.ppm"); we don't need the colormap for this project
    ...
    Camera::Instance().SetCameraEyePosition(125.0f,50.0f,500.0f);
            ...
            switch(e.type){
                ...
                case SDL_KEYDOWN:
                    switch(e.key.keysym.sym){
                        case SDLK_1:
                            terrainNode->changeShader("deep_sea_breathing");
                            break;
                        case SDLK_2:
                            terrainNode->changeShader("wave_sand_effect");
                            break;
                        case SDLK_3:
                            terrainNode->changeShader("shrinking_surface");
                            break;
                        case SDLK_4:
                            terrainNode->changeShader("regular_waves");
                            break;
                        case SDLK_5:
                            terrainNode->changeShader("smooth_wave");
                            break;
                        case SDLK_6:
                            terrainNode->changeShader("noisy_wave");
                            break;
                        case SDLK_7:
                            terrainNode->changeShader("speaker");
                            break;
                        case SDLK_LEFT:
